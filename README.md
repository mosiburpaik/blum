...
Click the following url to register : [https://t.me/blum/app?startapp=ref_UXJuYuQRor](https://t.me/blum/app?startapp=ref_UXJuYuQRor)
...
2. Clone this repository
   ```shell
   git clone https://github.com/mosiburpaik/blum.git
   ```
...
If you have any questions or need further assistance, join : [MRP Tech (Verified Only)](https://t.me/mrptechofficial)
